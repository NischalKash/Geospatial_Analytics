...
try:
    ...
    if connection.is_connected():
        ...
        new_array.append({'id': 'FM-MESOSCALE', 'parent_id': 'select transfer'})
        new_array.append({'id': 'MESOSCALE-LM', 'parent_id': 'select transfer'})
        ...
        for i in commodity_numbers_counties:
            ...
            for j in commodity_numbers_counties[i]:
                ...
                if row_state[0] in state_county_mapping:
                    state_county_mapping[row_state[0]].append([j[1],j[0]])
                else:
                    state_county_mapping[row_state[0]] = [[j[1],j[0]]]
        ...
        for commodity in final_dict:
            if final_dict[commodity]!={}:
                ...
                for state in final_dict[commodity]:
                    ...
                    for county in final_dict[commodity][state]:
                        temp_dict = {}
                        temp_dict["id"] = county[0]
                        temp_dict["county_id"] = county[1]
            ...
            if final_dict[commodity]!={}:
                temp_dict = {}
                temp_dict["id"] = commodity
                temp_dict["parent_id"] = 'MESOSCALE-LM'
                new_array.append(temp_dict)
                for state in final_dict[commodity]:
                    temp_dict = {}
                    temp_dict["id"]=state
                    temp_dict["parent_id"] = commodity
                    temp_dict["sc_step"] = 'MESOSCALE-LM'
                    new_array.append(temp_dict)
                    for county in final_dict[commodity][state]:
                        temp_dict = {}
                        temp_dict["id"] = county[0]
        ...
        for commodity in final_dict:
            ...
            if final_dict[commodity] != {}:
                temp_dict = {}
                temp_dict["id"] = commodity
                temp_dict["parent_id"] = 'FM-MESOSCALE'
                ...
                for state in final_dict[commodity]:
                    ...
                    temp_dict["id"] = state
                    temp_dict["parent_id"] = commodity
                    temp_dict["sc_step"] = 'FM-MESOSCALE'
                    new_array.append(temp_dict)
                    for county in final_dict[commodity][state]:
                        temp_dict = {}
                        temp_dict["id"] = county[0]
        ...
        with open("visualization/templates/visualization/data.json", "w") as outfile:
