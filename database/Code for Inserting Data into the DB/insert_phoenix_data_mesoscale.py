...
try:
    ...
    if connection.is_connected():
        ...
        with open('phoenix_inflows_to_distribution_centers_data_refining.csv', 'r') as read_obj:
        ...
        with open('Phoenix_inflows_to_food_processors_data_refining.csv', 'r') as read_obj:
            csv_reader = reader(read_obj)
            for row in csv_reader:
                mesoscale_id = str(next_val + 1)
                origin_county = str(row[0])
